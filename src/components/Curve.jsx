...
const Curve = () => {
  const [yieldStrength, setYieldStrength] = useState("2000");
  const [ultimateStrength, setUltimateStrength] = useState("9000");
  const [elasticModulus, setElasticModulus] = useState("28000");
